           ...
           // color: Colors.blue,
            ...
            Column(
              children: [
                ...
                Container(
                  color: Colors.amber,
                        child:QueryArtworkWidget(id: int.parse(playing.audio.audio.metas.id!), type:ArtworkType.AUDIO,
                    ...
                    children: [
                          ...
                          children: [
                            Expanded(flex: 7,
                              child: Column(
                                ...
                                children: [
                                  Text(playing.audio.audio.metas.title!,overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: 23,color: Color.fromARGB(255, 255, 255, 255),fontWeight: FontWeight.bold),),
                                  SizedBox(height: 10,),
                                  Text(playing.audio.audio.metas.artist!,overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: 19,color: Colors.white,fontWeight: FontWeight.bold),)
                                ],
                              ),
                            ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          }, icon: playstate==false ? Icon(Icons.play_arrow,color: Colors.white ):Icon(Icons.pause,color: Colors.white)
